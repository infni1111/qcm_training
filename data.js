...
// Chaque QCM : { title, explanation, children: [reponses] }.
  ...
  children: [
    {
      ...
      children: [
        { level: 2, id: "ch1_q1", title: "Quelle couche du modèle OSI gère le routage IP ?",
        ...
        { level: 2, id: "ch1_q2", title: "Parmi ces adresses, lesquelles sont privées (RFC 1918) ?",
        ...
        { level: 2, id: "ch1_q3", title: "Quel protocole de transport est orienté connexion ?",
        ...
        { level: 2, id: "ch1_q4", title: "Quelle est la taille d'une adresse MAC ?",
        ...
        { level: 2, id: "ch1_q5", title: "Masque par défaut d'une adresse de classe C ?",
    ...
    },
    {
      ...
      children: [
        { level: 2, id: "ch2_q1", title: "Quelle commande IOS affiche la table de routage ?",
        ...
        { level: 2, id: "ch2_q2", title: "STP : quels rôles de port existent ? (plusieurs)",
        ...
        { level: 2, id: "ch2_q3", title: "VLAN par défaut sur un switch Cisco ?",
        ...
        { level: 2, id: "ch2_q4", title: "Taille du tag 802.1Q ajouté à une trame ?",
        ...
        { level: 2, id: "ch2_q5", title: "Quels protocoles négocient un EtherChannel ? (plusieurs)",
    ...
    },
    {
      ...
      children: [
        { level: 2, id: "ch3_q1", title: "Lesquels sont des IGP ? (plusieurs)",
        ...
        { level: 2, id: "ch3_q2", title: "Rôle de l'area 0 en OSPF ?",
        ...
        { level: 2, id: "ch3_q3", title: "Distance administrative (AD) d'OSPF ?",
        ...
        { level: 2, id: "ch3_q4", title: "Quelle est la route par défaut IPv4 ?",
        ...
        { level: 2, id: "ch3_q5", title: "Quelle commande crée une route statique sur IOS ?",
    ...
    },
    {
      ...
      children: [
        { level: 2, id: "ch4_q1", title: "Ordre des messages DHCP pour obtenir une IP ?",
        ...
        { level: 2, id: "ch4_q2", title: "Types de NAT possibles sur IOS ? (plusieurs)",
        ...
        { level: 2, id: "ch4_q3", title: "Port et transport utilisés par NTP ?",
        ...
        { level: 2, id: "ch4_q4", title: "Syslog : quel est le niveau de sévérité 0 ?",
        ...
        { level: 2, id: "ch4_q5", title: "Quel protocole attribue dynamiquement des adresses IPv6 via SLAAC ?",
    ...
    },
    {
      ...
      children: [
        { level: 2, id: "ch5_q1", title: "Types d'ACL standards sur Cisco IOS ? (plusieurs)",
        ...
        { level: 2, id: "ch5_q2", title: "Sur quel port TCP SSH écoute-t-il par défaut ?",
        ...
        { level: 2, id: "ch5_q3", title: "Modes de violation en port-security ? (plusieurs)",
        ...
        { level: 2, id: "ch5_q4", title: "Quel chiffrement WPA2 est recommandé ?",
        ...
        { level: 2, id: "ch5_q5", title: "Différence entre enable password et enable secret ?",
    ...
    },
    {
      ...
      children: [
        { level: 2, id: "ch6_q1", title: "Caractéristiques d'une API REST ? (plusieurs)",
        ...
        { level: 2, id: "ch6_q2", title: "Quel format est le plus léger généralement ?",
        ...
        { level: 2, id: "ch6_q3", title: "Ansible est-il agent-less ?",
        ...
        { level: 2, id: "ch6_q4", title: "En SDN, le plan de contrôle est…",
        ...
        { level: 2, id: "ch6_q5", title: "YANG est utilisé avec quels protocoles ? (plusieurs)",
